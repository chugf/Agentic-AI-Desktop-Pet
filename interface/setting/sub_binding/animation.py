...
class AnimationBinding(QWidget):
    def __init__(self, languages, configure, param_dict, model_json_path, live2d_custom, **kwargs):
        ...
        self.motion_dict = live2d_custom.Parameters(model_json_path).get_motions
        self.expression_lists = live2d_custom.Parameters(model_json_path).get_expressions

        BodyLabel(self.languages[42], self).setGeometry(QRect(10, 10, 100, 30))
        ...
        self.select_actions.setGeometry(QRect(100, 10, 200, 30))

        BodyLabel("min(X)", self).setGeometry(QRect(10, 50, 100, 30))
        self.input_min_y = LineEdit(self)
        self.input_min_y.setGeometry(QRect(10, 80, 80, 30))
        BodyLabel("min(Y)", self).setGeometry(QRect(270, 50, 100, 30))
        self.input_min_x = LineEdit(self)
        self.input_min_x.setGeometry(QRect(270, 80, 80, 30))
        BodyLabel("max(X)", self).setGeometry(QRect(140, 50, 100, 30))
        self.input_max_y = LineEdit(self)
        self.input_max_y.setGeometry(QRect(140, 80, 80, 30))
        BodyLabel("max(Y)", self).setGeometry(QRect(400, 50, 100, 30))
        self.input_max_x = LineEdit(self)
        self.input_max_x.setGeometry(QRect(400, 80, 80, 30))
        ...
        self.click_auto_record.setGeometry(QRect(500, 70, 100, 30))

        BodyLabel(self.languages[44], self).setGeometry(QRect(10, 130, 100, 30))
        self.select_motion_name = ComboBox(self)
        self.select_motion_name.addItems(
            self.motion_dict[list(self.motion_dict.keys())[0]])
        self.select_motion_name.setGeometry(QRect(260, 130, 300, 30))
        ...
        BodyLabel(self.languages[49], self).setGeometry(QRect(260, 160, 100, 30))
        ...
        self.select_motion_group.setGeometry(QRect(100, 130, 150, 30))
        self.select_motion_group.setToolTip(self.languages[90])
        BodyLabel(self.languages[48], self).setGeometry(QRect(100, 160, 100, 30))

        BodyLabel(self.languages[51], self).setGeometry(QRect(10, 190, 100, 30))
        ...
        self.select_expression_name.setGeometry(QRect(100, 190, 300, 30))
        self.select_expression_name.currentTextChanged.connect(self.change_expression_name)

        BodyLabel(self.languages[156], self).setGeometry(QRect(10, 230, 100, 30))
        self.input_import_audio = LineEdit(self)
        self.input_import_audio.setGeometry(QRect(100, 230, 200, 30))
        self.select_save_folder = ComboBox(self)
        self.select_save_folder.addItems(list(template['voice'].keys()))
        self.select_save_folder.setGeometry(QRect(300, 230, 100, 30))
        ...
        self.click_choose_audio.setGeometry(QRect(400, 230, 100, 30))
        ...
        self.click_import_audio.setGeometry(QRect(510, 230, 100, 30))

        BodyLabel(self.languages[52], self).setGeometry(QRect(10, 270, 100, 30))
        self.select_audio = ComboBox(self)
        self.select_audio.addItems(list(template['voice'].keys()))
        self.select_audio.setGeometry(QRect(100, 270, 300, 30))
        self.select_audio.currentTextChanged.connect(self.change_play_audio)

        BodyLabel(self.languages[53], self).setGeometry(QRect(10, 300, 100, 30))
        ...
        self.select_audio_play.setGeometry(QRect(100, 300, 300, 30))
        ...
        self.click_save_animation.setGeometry(QRect(0, 430, 620, 30))
