...
class VoiceParameter(QWidget):
    def __init__(self, configure, parent=None):
        ...
        # speed
        BodyLabel("speed", self).setGeometry(QRect(10, 110, 60, 35))
        ...
        self.speed.setGeometry(QRect(100, 120, 300, 35))
        ...
        self.show_speed.setGeometry(QRect(420, 110, 60, 35))

        # batch_size
        BodyLabel("batch_size", self).setGeometry(QRect(10, 155, 80, 35))
        ...
        self.batch_size.setGeometry(QRect(100, 165, 300, 35))
        ...
        self.show_batch_size.setGeometry(QRect(420, 155, 60, 35))

        # batch_threshold
        BodyLabel("batch_threshold", self).setGeometry(QRect(10, 190, 100, 35))
        ...
        self.batch_threshold.setGeometry(QRect(100, 200, 300, 35))
        ...
        self.show_batch_threshold.setGeometry(QRect(420, 190, 60, 35))
